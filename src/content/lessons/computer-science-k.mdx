---
title: "Computer Science Fundamentals for Kindergarten"
status: "draft"
subject: "Computer Science"
grade: "k"
durationMinutes: 15
solCodes: ["CS.K.1","CS.K.2"]
objective: "Students will demonstrate understanding of foundational computer science concepts appropriate for Kindergarten."
materials:
...
standardsLinks:
  - label: "Virginia SOL CS"
    url: "https://doe.virginia.gov/"
tags:
  - "fundamentals"
  - "introduction"
  - "computer-science"
updatedAt: 2026-02-27T21:03:41.765Z
---

## Warm-up (3 minutes)

Begin with a brief discussion to activate prior knowledge:
- Ask students what they already know about computer science
...
**Key Concept**: Foundational principles of Computer Science at the Kindergarten level.
...
**Preparation**:
- Review the Virginia SOL standards for Computer Science at the Kindergarten level
