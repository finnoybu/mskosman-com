---
title: "Digital Learning Integration Fundamentals for 3rd Grade"
subject: "Digital Learning Integration"
grade: "3"
durationMinutes: 15
solCodes: ["DLI.3.1","DLI.3.2"]
objective: "Students will demonstrate understanding of foundational digital learning integration concepts appropriate for 3rd Grade."
materials:
...
**Key Concept**: Foundational principles of Digital Learning Integration at the 3rd Grade level.
...
**Preparation**:
- Review the Virginia SOL standards for Digital Learning Integration at the 3rd Grade level
