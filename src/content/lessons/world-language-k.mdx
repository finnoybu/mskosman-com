---
title: "World Language Fundamentals for Kindergarten"
subject: "World Language"
grade: "k"
durationMinutes: 15
solCodes: ["WL.K.1","WL.K.2"]
objective: "Students will demonstrate understanding of foundational world language concepts appropriate for Kindergarten."
materials:
...
standardsLinks:
  - label: "Virginia SOL WL"
    url: "https://doe.virginia.gov/"
tags:
  - "fundamentals"
  - "introduction"
  - "world-language"
updatedAt: 2026-02-27T21:03:41.812Z
---

## Warm-up (3 minutes)

Begin with a brief discussion to activate prior knowledge:
- Ask students what they already know about world language
...
**Key Concept**: Foundational principles of World Language at the Kindergarten level.
...
**Preparation**:
- Review the Virginia SOL standards for World Language at the Kindergarten level
